...
svgs = {
    ...
    'Posit Cloud': '<svg viewBox="0 0 24 24" fill="currentColor" stroke="none"><g transform="translate(12, 12) rotate(-45) translate(-7, -7)"><path d="M0 0h14v3.5H3.5v10.5H0z" /><path d="M5.25 5.25h8.75v3.5H8.75v5.25h-3.5z" /><path d="M10.5 10.5h3.5v3.5h-3.5z" /></g></svg>',
}
